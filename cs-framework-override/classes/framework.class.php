...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<h1>Settings and configuration <small>Do not forget to push the save button</small></h1>';
      echo '<fieldset>';
      ...
      echo 'This theme uses codestar Framework <strong>v'. CS_VERSION .' by Codestar</strong>';
