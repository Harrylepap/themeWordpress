...
$options[]      = array(
  ...
  'fields'      => array(
   ...
   /* array(
	...
	// Site   
    array(
      'id'      => 'site_videobackground',
      'type'    => 'upload',
      'title'   => 'Upload Video Background',
      'help'    => 'Upload a video for background',
      'settings'       => array(
          'upload_type'  => 'video',
    ...
    array(
      'id'      => 'site_home_videobackground_enable',
      'type'    => 'switcher',
      'title'   => 'Home page uses video background',
      'label'   => 'Do you want to use video as background of the home page of the website ?',
    ),
    array(
      'id'      => 'site_allpages_videobackground_enable',
      'type'    => 'switcher',
      'title'   => 'All pages use video background',
      'label'   => 'Do you want to use video as background of every pages of the website ?',
    ),

    array(
      'id'      => 'site_mask_background',
      'type'    => 'color_picker',
   ...
   /* array(
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'This will overwrite the background image choosen in the customizer :',
    ),
...
// ------------------------------
$options[] = array(
  'name'   => 'home_page_separator',
  'title'  => 'Home Page',
  'icon'   => 'fa fa-home'
);
// BEGIN OF HOME PAGE ARRAYS
// -----------------------------
// begin: Sections visibility       
// -----------------------------
$options[] = array(
  'name'      => 'section_visibility_home',
  ...
  'fields'    => array(
    ...
    array(
      ...
      //'type'    => 'switcher',
      'type'    => 'checkbox',
      'title'   => 'Hide About section at home page',
      'default' => false,
    ),
    array(
      'id'      => 'home_hide_team',
      'type'    => 'checkbox',
      'title'   => 'Hide Team section at home page',
      'default' => false,
    ),
    array(
      'id'      => 'home_hide_leadership',
      'type'    => 'checkbox',
      'title'   => 'Hide Leadership section at home page',
      'default' => false,
    ),
    array(
      'id'      => 'home_hide_partners',
      'type'    => 'checkbox',
      'title'   => 'Hide Partners section at home page',
      'default' => false,
    ),
    array(
      'id'      => 'home_hide_gallery',
      'type'    => 'checkbox',
      'title'   => 'Hide Gallery section at home page',
      'default' => false,
    ),
		
  ), // end: fields
);// end: Sections visibility       

// -----------------------------
// begin: top of home page          
// -----------------------------
$options[] = array(
  'name'      => 'top_section_home',
  'title'     => 'Top Section',
  'icon'      => 'fa fa-home',
  ...
  'fields'    => array(
	...
	array(
	  ...
	  'default' => 'Teach For Madagascar',
	  'help'  => 'Title to show at the top of the page.',
	  'attributes'    => array(
		'placeholder' => ''
	  )
	),
	...
	array(
	  'id'    => 'home_top_description',
	  'type'  => 'textarea',
	  'title' => 'Description',
	  'default' => 'If you have knowledge let others light their candles in it.',
	  'desc'  => 'Home page descripion or main text',
	),

	array(
	  'id'         => 'home_top_learnmore_text',
	  'type'       => 'text',
...
); // end: top of home page

// -----------------------------
// begin: About us section options     -
// -----------------------------
$options[] = array(
  'name'      => 'about_section_home',
  'title'     => 'About',
  'icon'      => 'fa fa-flag',
  'fields'    => array(
	...
	array(
	  ...
	  'type'  => 'wysiwyg',
	  'title' => 'Description',
	  'desc'  => 'Description about the organization',
	  'settings' => array(
		'textarea_rows' => 20,
	  )
	),
	...
	array(
	  'id'    => 'about_rightsidebar_title',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Title',
	  'default' => 'About Us',
	),
	array(
	  'id'    => 'about_rightsidebar_quote',
	  'type'  => 'textarea',
	  'title' => 'Right Sidebar Quote',
	  'default' => '',
	),
	array(
	  'id'    => 'about_rightsidebar_quote_author',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Quote Author',
	  'default' => '',
	),
/*
	array(
...
$options[] = array(
  ...
  'fields'    => array(
	...
	array(
	  ...
	  'type'  => 'wysiwyg',
	  'title' => 'Description',
	  'desc'  => 'Description about the team',
	  'settings' => array(
		'textarea_rows' => 20,
	  )
	),
	...
	array(
	  'id'    => 'team_rightsidebar_title',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Title',
	  'default' => 'About Us',
	),
	array(
	  'id'    => 'team_rightsidebar_quote',
	  'type'  => 'textarea',
	  'title' => 'Right Sidebar Quote',
	  'default' => '',
	),
	array(
	  'id'    => 'team_rightsidebar_quote_author',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Quote Author',
	  'default' => '',
	),
...
// -----------------------------
// begin: leadership section options     -
// -----------------------------
$options[] = array(
  'name'      => 'leadership_section_home',
  'title'     => 'Leadership',
  'icon'      => 'fa fa-user',
  'fields'    => array(
	...
	array(
	  ...
	  'type'  => 'text',
	  'title' => 'Title',
	  'default' => 'Join our leadership team',
	),
	...
	array(
	  'id'    => 'leadership_rightsidebar_title',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Title',
	  'default' => 'TFM Leadership team',
	),
	array(
	  'id'    => 'leadership_rightsidebar_quote',
	  'type'  => 'textarea',
	  'title' => 'Right Sidebar Quote',
	  'default' => '',
	),
	array(
	  'id'    => 'leadership_rightsidebar_quote_author',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Quote Author',
	  'default' => '',
	),
...
$options[] = array(
  ...
  'fields'          => array(
	...
	array(
	  ...
	  'type'  => 'wysiwyg',
	  'title' => 'Description',
	  'desc'  => 'Description the partnership',
	  'settings' => array(
		'textarea_rows' => 20,
	  )
	),
	...
	array(
	  'id'    => 'partners_rightsidebar_title',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Title',
	  'default' => 'Partners',
	),
	...
	array(
	  ...
	  'type'        => 'gallery',
	  'title'       => 'Partners (Logo)',
		'desc'        => 'Select Logos of you partners or supporters',
	),

	array(
	  'id'    => 'partners_rightsidebar_quote',
	  'type'  => 'textarea',
	  'title' => 'Right Sidebar Quote',
	  'default' => '',
	),
	array(
	  'id'    => 'partners_rightsidebar_quote_author',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Quote Author',
	  'default' => '',
	),
...
$options[] = array(
  ...
  'fields'          => array(
	...
	array(
	  ...
	  'type'        => 'gallery',
	  'title'       => 'Gallery',
		'desc'        => 'Select 5 photos to show on the home page',
	),
	array(
	  'id'    => 'gallery_rightsidebar_title',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Title',
	  'default' => 'Pictures',
	),
	array(
	  'id'    => 'gallery_rightsidebar_quote',
	  'type'  => 'textarea',
	  'title' => 'Right Sidebar Quote',
	  'default' => '',
	),
	array(
	  'id'    => 'gallery_rightsidebar_quote_author',
	  'type'  => 'text',
	  'title' => 'Right Sidebar Quote Author',
	  'default' => '',
	),
